...
\addplot+[mark=none,domain=0:720,samples=600,thick] {14.14*(cos(x)+sin(x))};
\addplot+[mark=none,domain=0:720,samples=600,thick] {14.14*(cos(x)-sin(x))};
\addplot+[mark=none,domain=0:720,samples=600,thick,color=blue] {-14.14*(cos(x)+sin(x))};
\addplot+[mark=none,domain=0:720,samples=600,thick,color=red] {-14.14*(cos(x)-sin(x))};
\end{polaraxis}
\end{tikzpicture}
\end{center}
